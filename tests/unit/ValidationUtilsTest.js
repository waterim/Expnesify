...
describe('ValidationUtils', () => {
    describe('isValidDate', () => {
        test('isValidDate should return true for a valid date within the range', () => {
        ...
        test('isValidDate should return false for an empty date', () => {
            const invalidDate = '';
            const isValid = ValidationUtils.isValidDate(invalidDate);
            expect(isValid).toBe(false);
        });

        test('isValidDate should return false for a date after the range', () => {
    ...
    describe('isValidPastDate', () => {
        test('isValidPastDate should return true for a valid past date within the range', () => {
            const validPastDate = '1990-01-01';
            const isValid = ValidationUtils.isValidPastDate(validPastDate);
            expect(isValid).toBe(true);
        });

        test('isValidPastDate should return false for an invalid date', () => {
            const invalidDate = '2023-07-32';
            const isValid = ValidationUtils.isValidPastDate(invalidDate);
            expect(isValid).toBe(false);
        });

        test('isValidPastDate should return false for an empty date', () => {
            const emptyDate = '';
